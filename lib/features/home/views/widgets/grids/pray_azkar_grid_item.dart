...
class PrayAzkarGridItem extends StatelessWidget {
  const PrayAzkarGridItem({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FeatureGridCard(
      ...
      label: l10n?.translate('home.pray_azkar') ?? 'أذكار الصلاة',
      onTap: () => _showAzkarSheet(context, 'assets/json_data/pray_azkar.json'),
      trailing: GridProgressBadge(
        assetPath: 'assets/json_data/pray_azkar.json',
        prefsPrefix: 'pray_azkar_',
      ),
    );
  }
