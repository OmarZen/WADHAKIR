...
class CuratedQuotes {
  ...
  static const List<BackgroundQuote> all = [
    BackgroundQuote('وَذَكِّرْ فَإِنَّ ٱلذِّكْرَىٰ تَنفَعُ ٱلْمُؤْمِنِينَ', 'الذاريات ٥٥'),
    BackgroundQuote('فَٱذْكُرُونِىٓ أَذْكُرْكُمْ', 'البقرة ١٥٢'),
    BackgroundQuote('أَلَا بِذِكْرِ ٱللَّهِ تَطْمَئِنُّ ٱلْقُلُوبُ', 'الرعد ٢٨'),
    ...
    BackgroundQuote('اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَىٰ نَبِيِّنَا مُحَمَّد', 'صلاة على النبي'),
